...
static inline void
volk_8u_x3_encodepolarpuppet_8u_u_avx512bw(unsigned char* frame,
                                            unsigned char* frozen_bit_mask,
                                            const unsigned char* frozen_bits,
                                            const unsigned char* info_bits,
                                            unsigned int frame_size)
{
    ...
    unsigned char* temp = (unsigned char*)volk_malloc(sizeof(unsigned char) * frame_size,
                                                      volk_get_alignment());
    adjust_frozen_mask(frozen_bit_mask, frame_size);
    volk_8u_x3_encodepolar_8u_x2_u_avx512bw(
        frame, temp, frozen_bit_mask, frozen_bits, info_bits, frame_size);
    volk_free(temp);
}
...
#ifdef LV_HAVE_AVX512BW
static inline void
volk_8u_x3_encodepolarpuppet_8u_a_avx512bw(unsigned char* frame,
                                            unsigned char* frozen_bit_mask,
                                            const unsigned char* frozen_bits,
                                            const unsigned char* info_bits,
                                            unsigned int frame_size)
{
    ...
    unsigned char* temp = (unsigned char*)volk_malloc(sizeof(unsigned char) * frame_size,
                                                      volk_get_alignment());
    adjust_frozen_mask(frozen_bit_mask, frame_size);
    volk_8u_x3_encodepolar_8u_x2_a_avx512bw(
        frame, temp, frozen_bit_mask, frozen_bits, info_bits, frame_size);
    volk_free(temp);
}
#endif /* LV_HAVE_AVX512BW */
