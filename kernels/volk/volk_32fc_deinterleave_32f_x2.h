...
#ifdef LV_HAVE_AVX2
#include <immintrin.h>
static inline void volk_32fc_deinterleave_32f_x2_u_avx2(float* iBuffer,
                                                       float* qBuffer,
                                                       const lv_32fc_t* complexVector,
                                                       unsigned int num_points)
{
...
extern void volk_32fc_deinterleave_32f_x2_a_orc_impl(float* iBuffer,
                                                      float* qBuffer,
                                                      const lv_32fc_t* complexVector,
                                                      int num_points);

static inline void volk_32fc_deinterleave_32f_x2_u_orc(float* iBuffer,
                                                        float* qBuffer,
                                                        const lv_32fc_t* complexVector,
                                                        unsigned int num_points)
{
    volk_32fc_deinterleave_32f_x2_a_orc_impl(iBuffer, qBuffer, complexVector, num_points);
}
...
#ifdef LV_HAVE_AVX2
#include <immintrin.h>
static inline void volk_32fc_deinterleave_32f_x2_a_avx2(float* iBuffer,
                                                       float* qBuffer,
                                                       const lv_32fc_t* complexVector,
                                                       unsigned int num_points)
{
