                                                 ...
                                                 unsigned int num_points)
{
    ...
    __m128 aVal, bVal, cVal, logarithm, mantissa, frac, leadingOne;
    __m128 tmp, fx, pow2n, z, y;
    __m128 one, exp_hi, exp_lo, ln2, log2EF, half, exp_C1, exp_C2;
    __m128 exp_p0, exp_p1, exp_p2, exp_p3, exp_p4, exp_p5;
    __m128i bias, exp, emm0, pi32_0x7f;

    one = _mm_set1_ps(1.0f);
    exp_hi = _mm_set1_ps(88.3762626647949f);
    exp_lo = _mm_set1_ps(-88.3762626647949f);
    ln2 = _mm_set1_ps(0.6931471805f);
    log2EF = _mm_set1_ps(1.44269504088896341f);
    half = _mm_set1_ps(0.5f);
    exp_C1 = _mm_set1_ps(0.693359375f);
    exp_C2 = _mm_set1_ps(-2.12194440e-4f);
    pi32_0x7f = _mm_set1_epi32(0x7f);

    exp_p0 = _mm_set1_ps(1.9875691500e-4f);
    exp_p1 = _mm_set1_ps(1.3981999507e-3f);
    exp_p2 = _mm_set1_ps(8.3334519073e-3f);
    exp_p3 = _mm_set1_ps(4.1665795894e-2f);
    exp_p4 = _mm_set1_ps(1.6666665459e-1f);
    exp_p5 = _mm_set1_ps(5.0000001201e-1f);
...
static inline void volk_32f_x2_pow_32f_u_avx512f(float* cVector,
                                                   const float* bVector,
                                                   const float* aVector,
                                                   unsigned int num_points)
{
    ...
    for (; number < sixteenthPoints; number++) {
        ...
        frac = _mm512_castsi512_ps(_mm512_or_epi32(
            _mm512_castps_si512(leadingOne),
            _mm512_and_epi32(_mm512_castps_si512(aVal), _mm512_set1_epi32(0x7fffff))));
...
static inline void volk_32f_x2_pow_32f_a_avx512f(float* cVector,
                                                   const float* bVector,
                                                   const float* aVector,
                                                   unsigned int num_points)
{
