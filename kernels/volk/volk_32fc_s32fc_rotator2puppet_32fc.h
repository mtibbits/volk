...
static inline void volk_32fc_s32fc_rotator2puppet_32fc_a_sse(lv_32fc_t* outVector,
                                                              const lv_32fc_t* inVector,
                                                              const lv_32fc_t* phase_inc,
                                                              unsigned int num_points)
{
...
static inline void volk_32fc_s32fc_rotator2puppet_32fc_u_sse(lv_32fc_t* outVector,
                                                              const lv_32fc_t* inVector,
                                                              const lv_32fc_t* phase_inc,
                                                              unsigned int num_points)
{
