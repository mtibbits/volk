...
static inline void volk_32f_s32f_stddev_32f_u_sse(float* stddev,
                                                   const float* inputBuffer,
                                                   const float mean,
                                                   unsigned int num_points)
{
...
static inline void volk_32f_s32f_stddev_32f_u_sse4_1(float* stddev,
                                                      const float* inputBuffer,
                                                      const float mean,
                                                      unsigned int num_points)
{
...
static inline void volk_32f_s32f_stddev_32f_u_avx2_fma(float* stddev,
                                                        const float* inputBuffer,
                                                        const float mean,
                                                        unsigned int num_points)
{
                                                       ...
                                                       unsigned int num_points)
{
    ...
    if (num_points > 0) {
        ...
        __m512 squareAccumulator0 = _mm512_setzero_ps();
        __m512 squareAccumulator1 = _mm512_setzero_ps();
        __m512 squareAccumulator2 = _mm512_setzero_ps();
        __m512 squareAccumulator3 = _mm512_setzero_ps();

        for (; number < sixtyfourthPoints; number++) {
            __m512 aVal0 = _mm512_loadu_ps(aPtr);
            __m512 aVal1 = _mm512_loadu_ps(aPtr + 16);
            __m512 aVal2 = _mm512_loadu_ps(aPtr + 32);
            __m512 aVal3 = _mm512_loadu_ps(aPtr + 48);

            squareAccumulator0 = _mm512_fmadd_ps(aVal0, aVal0, squareAccumulator0);
            squareAccumulator1 = _mm512_fmadd_ps(aVal1, aVal1, squareAccumulator1);
            squareAccumulator2 = _mm512_fmadd_ps(aVal2, aVal2, squareAccumulator2);
            squareAccumulator3 = _mm512_fmadd_ps(aVal3, aVal3, squareAccumulator3);

            aPtr += 64;
        }

        squareAccumulator0 = _mm512_add_ps(squareAccumulator0, squareAccumulator1);
        squareAccumulator2 = _mm512_add_ps(squareAccumulator2, squareAccumulator3);
        squareAccumulator0 = _mm512_add_ps(squareAccumulator0, squareAccumulator2);

        returnValue = _mm512_reduce_add_ps(squareAccumulator0);
...
static inline void volk_32f_s32f_stddev_32f_a_avx2_fma(float* stddev,
                                                        const float* inputBuffer,
                                                        const float mean,
                                                        unsigned int num_points)
{
                                                       ...
                                                       unsigned int num_points)
{
    ...
    if (num_points > 0) {
        ...
        for (; number < sixtyfourthPoints; number++) {
            __m512 aVal0 = _mm512_load_ps(aPtr);
            __m512 aVal1 = _mm512_load_ps(aPtr + 16);
            __m512 aVal2 = _mm512_load_ps(aPtr + 32);
            __m512 aVal3 = _mm512_load_ps(aPtr + 48);
