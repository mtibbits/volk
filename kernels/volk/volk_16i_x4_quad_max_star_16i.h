 ...
 * \code
 * void volk_16i_x4_quad_max_star_16i(short* target, const const short* src0, const const short* src1,
 * const const short* src2, const const short* src3, unsigned int num_points) \endcode
 *
 * \b Inputs
