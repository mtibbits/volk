...
static inline void volk_32fc_s32f_atan2_32f_u_avx_fma(float* outputVector,
                                                       const lv_32fc_t* complexVector,
                                                       const float normalizeFactor,
                                                       unsigned int num_points)
{
...
static inline void volk_32fc_s32f_atan2_32f_u_avx512f(float* outputVector,
                                                       const lv_32fc_t* complexVector,
                                                       const float normalizeFactor,
                                                       unsigned int num_points)
{
    ...
    for (unsigned int number = 0; number < sixteenth_points; number++) {
        ...
        const __m512 inf = _mm512_set1_ps(HUGE_VALF);
        const __m512 pi_4 = _mm512_set1_ps(0x1.921fb6p-1f);      /* pi/4 */
        const __m512 three_pi_4 = _mm512_set1_ps(0x1.2d97c8p1f); /* 3pi/4 */

        __m512 y_abs = _mm512_castsi512_ps(
            _mm512_and_si512(_mm512_castps_si512(y), _mm512_castps_si512(abs_mask)));
        __m512 x_abs = _mm512_castsi512_ps(
            _mm512_and_si512(_mm512_castps_si512(x), _mm512_castps_si512(abs_mask)));
        __mmask16 y_inf_mask = _mm512_cmp_ps_mask(y_abs, inf, _CMP_EQ_OQ);
        __mmask16 x_inf_mask = _mm512_cmp_ps_mask(x_abs, inf, _CMP_EQ_OQ);
        ...
        both_inf_result = _mm512_castsi512_ps(
            _mm512_or_si512(_mm512_castps_si512(both_inf_result),
                            _mm512_and_si512(_mm512_castps_si512(y),
        ...
        __m512 y_inf_result = _mm512_castsi512_ps(
            _mm512_or_si512(_mm512_castps_si512(pi_2),
                            _mm512_and_si512(_mm512_castps_si512(y),
                                             _mm512_castps_si512(sign_mask))));
        ...
        __m512 y_sign = _mm512_castsi512_ps(
            _mm512_and_si512(_mm512_castps_si512(y), _mm512_castps_si512(sign_mask)));
        __m512 x_inf_result =
            _mm512_mask_blend_ps(x_pos_mask,
                                 _mm512_castsi512_ps(
                                     _mm512_or_si512(_mm512_castps_si512(pi),
                                                     _mm512_castps_si512(y_sign))),
                                 _mm512_castsi512_ps(
                                     _mm512_or_si512(_mm512_castps_si512(zero),
                                                     _mm512_castps_si512(y_sign))));
        inf_result = _mm512_mask_blend_ps(x_inf_only, inf_result, x_inf_result);

        __mmask16 any_inf_mask = y_inf_mask | x_inf_mask;

        __mmask16 swap_mask = _mm512_cmp_ps_mask(y_abs, x_abs, _CMP_GT_OS);
        ...
        input = _mm512_sub_ps(
            _mm512_castsi512_ps(
                _mm512_or_si512(_mm512_castps_si512(pi_2),
                                _mm512_and_si512(_mm512_castps_si512(input),
                                                 _mm512_castps_si512(sign_mask)))),
            result);
        ...
        result = _mm512_add_ps(
            _mm512_castsi512_ps(
                _mm512_and_si512(
                    _mm512_xor_si512(
                        _mm512_castps_si512(pi),
                        _mm512_and_si512(_mm512_castps_si512(sign_mask),
                                         _mm512_castps_si512(y))),
                    _mm512_castps_si512(x_sign_mask))),
            result);
...
#include <immintrin.h>
#include <volk/volk_avx2_fma_intrinsics.h>
static inline void volk_32fc_s32f_atan2_32f_a_avx_fma(float* outputVector,
                                                       const lv_32fc_t* complexVector,
                                                       const float normalizeFactor,
                                                       unsigned int num_points)
{
...
#include <immintrin.h>
#include <volk/volk_avx512_intrinsics.h>
static inline void volk_32fc_s32f_atan2_32f_a_avx512f(float* outputVector,
                                                       const lv_32fc_t* complexVector,
                                                       const float normalizeFactor,
                                                       unsigned int num_points)
{
