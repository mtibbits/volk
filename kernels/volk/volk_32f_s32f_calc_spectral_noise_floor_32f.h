...
static inline void
volk_32f_s32f_calc_spectral_noise_floor_32f_u_avx_fma(float* noiseFloorAmplitude,
                                                       const float* realDataPoints,
                                                       const float spectralExclusionValue,
                                                       const unsigned int num_points)
{
...
static inline void
volk_32f_s32f_calc_spectral_noise_floor_32f_u_avx2(float* noiseFloorAmplitude,
                                                    const float* realDataPoints,
                                                    const float spectralExclusionValue,
                                                    const unsigned int num_points)
{
...
static inline void
volk_32f_s32f_calc_spectral_noise_floor_32f_u_avx2_fma(float* noiseFloorAmplitude,
                                                        const float* realDataPoints,
                                                        const float spectralExclusionValue,
                                                        const unsigned int num_points)
{
...
static inline void
volk_32f_s32f_calc_spectral_noise_floor_32f_a_avx_fma(float* noiseFloorAmplitude,
                                                       const float* realDataPoints,
                                                       const float spectralExclusionValue,
                                                       const unsigned int num_points)
{
...
static inline void
volk_32f_s32f_calc_spectral_noise_floor_32f_a_avx2(float* noiseFloorAmplitude,
                                                    const float* realDataPoints,
                                                    const float spectralExclusionValue,
                                                    const unsigned int num_points)
{
...
static inline void
volk_32f_s32f_calc_spectral_noise_floor_32f_a_avx2_fma(float* noiseFloorAmplitude,
                                                        const float* realDataPoints,
                                                        const float spectralExclusionValue,
                                                        const unsigned int num_points)
{
